...
{
    SetWindowPos(hwnd, NULL, NULL, NULL, width, height, SWP_FRAMECHANGED | WS_VISIBLE);
}

void CheckTheme()
{
    switch (VarData::ActiveTheme)
    {
    case 0:
        GuiSettings::CurrentTheme = "DarkPurple";
        break;
    case 1:
        GuiSettings::CurrentTheme = "WhitePurple";
        break;
    default:
        break;
    }
